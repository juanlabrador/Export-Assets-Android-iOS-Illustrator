...
if(document && folder) {
	...
	var nameField = nameGroup.add("edittext", undefined, "Name File");
	nameField.minimumSize.width = 200;   
...
function exportToFile(scaleFactor, resIdentifier, os, nameField) {
	...
	if(ab.name.charAt(0)=="!")
        ...
        if(os === "android")
            file = new File(expFolder.fsName + "/" + /*ab.name*/nameField + ".png");
        else if(os === "ios")
            file = new File(expFolder.fsName + "/" + /*ab.name*/nameField + resIdentifier + ".png");
